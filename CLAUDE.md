...
- **Mobile-first responsive design**: Always start with mobile breakpoints and progressively enhance for larger screens
- Use MUI's responsive breakpoints: `xs` (mobile), `sm` (tablet), `md` (desktop), `lg` (large desktop)
- Ensure compact, touch-friendly layouts for mobile devices
...
11. **Mobile-first approach**: Always design and code for mobile devices first, then enhance for larger screens.
12. Use responsive design with MUI breakpoints and ensure touch-friendly interfaces.
